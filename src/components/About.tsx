...
export default function About() {
  ...
  return (
    <Box mt={3} px={2}>
      <Typography mb={2} variant={isDesktop ? 'h1' : 'h6'}>
        About
      </Typography>
      <Typography variant={isDesktop ? 'h6' : 'subtitle1'}>
        ...
        amet..", comes from a line in section 1.10.32.Contrary to popular belief, Lorem Ipsum is not
        ...
        1.10.32.Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a
